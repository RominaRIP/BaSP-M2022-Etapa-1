...
var arrayA = ["heaven", "hell", "paranoid", "sabbath", "iron"];
...
for (i = 0; i < arrayA.length; i++) {
  arrayB = arrayA[i];
  arrayBCut = arrayB.substring(0, 1);
  arrayBUp = arrayBCut.toUpperCase();
  arrayBLow = arrayB.substring(1, );

  alert(arrayBUp + arrayBLow);
};
